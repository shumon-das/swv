      ...
      $props.item.to ? (openBlock(), createBlock(_component_router_link, {
        ...
        default: withCtx(({ navigate, href, isActive, isExactActive }) => [
          createVNode("a", {
            ...
            $props.item.label ? (openBlock(), createBlock("span", _hoisted_1$1, toDisplayString($options.label()), 1)) : createCommentVNode("", true)
          ], 10, ["href", "onClick"])
        ]),
        _: 1
        ...
        $props.item.label ? (openBlock(), createBlock("span", _hoisted_2$1, toDisplayString($options.label()), 1)) : createCommentVNode("", true)
      ], 10, ["href", "target"]))
